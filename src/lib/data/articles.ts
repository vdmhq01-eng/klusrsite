...
export const articles: Article[] = [
  {
    id: "muur-verven-stappenplan",
    title: "Muur verven in 6 stappen: zo doe je het als een pro",
    slug: "muur-verven-stappenplan",
    excerpt:
      "Van voorbereiding tot de laatste laag. Met deze stappen en het juiste gereedschap krijg jij een strak, egaal resultaat zonder aanzetten.",
    image: "https://picsum.photos/seed/klusr-art-muur/1200/675",
    category: "Verven",
    readingTime: 6,
    date: "2026-05-20",
    author: "Team KLUSR",
    body: [
      "Een muur verven lijkt eenvoudig, maar het verschil tussen amateur en pro zit in de voorbereiding. Begin met het leeghalen en afdekken van de ruimte. Verwijder stopcontactplaatjes en plak randen af met goede afplaktape.",
      "Stap 1 — Schoonmaken: Maak de muur stofvrij en vetvrij. Vuil en stof zorgen voor een slechte hechting.",
      "Stap 2 — Repareren: Vul gaatjes en scheuren met allesvuller en schuur na drogen glad.",
      "Stap 3 — Primer: Op een nieuwe of sterk zuigende ondergrond breng je eerst een primer aan voor een gelijkmatige dekking.",
      "Stap 4 — Randen: Snijd de hoeken en randen eerst in met een kwast (het zogenoemde 'voorsnijden').",
      "Stap 5 — Rollen: Rol de muur kruislings vol en werk af in één richting. Houd altijd een natte rand aan om aanzetten te voorkomen.",
      "Stap 6 — Tweede laag: Laat de eerste laag goed drogen en breng daarna een tweede laag aan voor een diep, egaal resultaat.",
    ],
  },
  {
    id: "juiste-kwast-kiezen",
    title: "Welke kwast of roller kies je? Het complete overzicht",
    slug: "juiste-kwast-of-roller-kiezen",
    excerpt:
      "Synthetisch of natuurhaar, korte of lange pool — de keuze van je gereedschap bepaalt je eindresultaat. We helpen je kiezen.",
    image: "https://picsum.photos/seed/klusr-art-kwast/1200/675",
    category: "Gereedschap",
    readingTime: 4,
    date: "2026-05-12",
    author: "Team KLUSR",
    body: [
      "De juiste kwast of roller maakt het verschil tussen zwoegen en soepel doorwerken. Voor watergedragen verf gebruik je een synthetische kwast; die behoudt zijn vorm en geeft de verf mooi gelijkmatig af.",
      "Voor muren en plafonds werk je het snelst met een roller. Kies een korte pool (8-12 mm) voor gladde muren en een langere pool voor structuur.",
      "Een radiatorkwast of klein rollertje is onmisbaar voor moeilijk bereikbare plekken zoals achter de verwarming.",
    ],
  },
  {
    id: "kleur-kiezen-interieur",
    title: "De juiste kleur kiezen voor je interieur",
    slug: "kleur-kiezen-interieur",
    excerpt:
      "Warme of koele tinten, accentmuur of niet? Met onze kleurkiezer en deze tips bepaal je makkelijk de sfeer van je ruimte.",
    image: "https://picsum.photos/seed/klusr-art-kleur/1200/675",
    category: "Inspiratie",
    readingTime: 5,
    date: "2026-04-28",
    author: "Team KLUSR",
    body: [
      "Kleur bepaalt de sfeer van een ruimte. Warme tinten zoals terracotta en oker maken een ruimte knus, terwijl koele tinten als saliegroen en rookblauw juist rust brengen.",
      "Twijfel je? Bestel kleurstalen of gebruik onze kleurkiezer om kleuren naast elkaar te vergelijken. Bekijk een kleur altijd bij daglicht én bij kunstlicht.",
      "Een accentmuur in een diepe kleur geeft karakter zonder dat de hele ruimte donker wordt. Combineer met een neutrale basis op de overige muren.",
    ],
  },
  {
    id: "schutting-beitsen",
    title: "Schutting beitsen: bescherm je tuinhout voor de winter",
    slug: "schutting-beitsen",
    excerpt:
      "Met de juiste beits gaat je schutting jaren langer mee. Lees hoe je het hout voorbereidt en de beits gelijkmatig aanbrengt.",
    image: "https://picsum.photos/seed/klusr-art-schutting/1200/675",
    category: "Tuin",
    readingTime: 5,
    date: "2026-04-15",
    author: "Team KLUSR",
    body: [
      "Onbehandeld tuinhout vergrijst en kan gaan rotten. Een goede beits beschermt tegen vocht en UV-straling en houdt je schutting jarenlang mooi.",
      "Begin met een droge ondergrond. Borstel vuil en groene aanslag weg en schuur ruwe plekken glad.",
      "Breng de beits aan in de richting van de houtnerf en werk steeds een hele plank in één keer af om aanzetten te voorkomen. Twee dunne lagen geven een beter en duurzamer resultaat dan één dikke laag.",
    ],
  },
  {
    id: "stopcontact-veilig-vervangen",
    title: "Stopcontact veilig vervangen: stap voor stap",
    slug: "stopcontact-veilig-vervangen",
    excerpt:
      "Een stopcontact vervangen kun je zelf, mits je het veilig aanpakt. Wij leggen uit hoe je de groep spanningsvrij maakt en het netjes aansluit.",
    image: "https://picsum.photos/seed/klusr-art-stopcontact/1200/675",
    category: "Elektra",
    readingTime: 4,
    date: "2026-03-30",
    author: "Team KLUSR",
    body: [
      "Veiligheid eerst: schakel de juiste groep uit in de meterkast en controleer met een spanningzoeker of er écht geen spanning meer staat.",
      "Maak het oude stopcontact los en noteer welke draad waar zit: bruin (fase), blauw (nul) en groen/geel (aarde).",
      "Sluit het nieuwe stopcontact op dezelfde manier aan, draai alles stevig vast en monteer het netjes in de inbouwdoos. Schakel daarna de groep weer in en test.",
      "Twijfel je over de bedrading of gaat het om een nieuwe groep? Schakel dan altijd een erkend installateur in.",
    ],
  },
  {
    id: "laminaat-leggen-tips",
    title: "Laminaat leggen: 7 tips voor een strak resultaat",
    slug: "laminaat-leggen-tips",
    excerpt:
      "Met kliklaminaat leg je zelf een mooie vloer. Let op de ondervloer, de legrichting en een nette dilatatievoeg langs de muur.",
    image: "https://picsum.photos/seed/klusr-art-laminaat/1200/675",
    category: "Vloeren",
    readingTime: 6,
    date: "2026-03-18",
    author: "Team KLUSR",
    body: [
      "Laat het laminaat eerst 48 uur acclimatiseren in de ruimte waar je het gaat leggen. Zo voorkom je werken van de vloer na het leggen.",
